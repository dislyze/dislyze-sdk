...
<div class="dislyze-container">
    ...
    <div class="dislyze-feedback-box" style="{getBoxPositionStyle()}">
        ...
        />
        <div style="margin-bottom:8px;">Feedback details</div>
        <textarea
            class="dislyze-input-field"
...
.dislyze-input-field {
    ...
    border-radius: 8px;
    padding: 8px;
    box-shadow: 0 3px 15px 1px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);
    width: calc(100% - 16px);
    resize: none;
}
